# -*- coding: utf-8 -*-
"""
Created on Thu Apr 23 15:54:49 2020

@author: kanishk pandey
"""

import turtle
import time #if we don't iimport this, the snake will run off the screen even before we could see it.
import random

delay=0.1
#screen
s1=turtle.Screen() #S should always be capital
s1.title("SNAKES.......BY KANISHK")
s1.bgcolor("blue")
